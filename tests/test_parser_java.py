...
data = [
    ...
    # ('Strings.java', 'Strings.txt'),
    # ('HotelRepository.java', 'HotelRepository.txt'),
    # ('ConcurrentIdentityHashMap.java', 'ConcurrentIdentityHashMap.txt'),
    ('SetHashCodeTester.java', 'SetHashCodeTester.txt'),
]
